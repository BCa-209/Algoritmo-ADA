...
def cargar_grafo_desde_csv(ruta_archivo):
    """
    Carga un grafo desde un archivo CSV que contiene la matriz de adyacencia.
    """
    try:
        # Cargar el CSV y convertirlo en una matriz de adyacencia
        ...
        print(f"Grafo cargado desde CSV: {ruta_archivo}")
...
def main():
    ...
    Función principal
    """
    archivo_csv = 'karate.csv'  # Ruta al archivo CSV
    
    # Cargar grafo desde archivo CSV
    G = cargar_grafo_desde_csv(archivo_csv)
